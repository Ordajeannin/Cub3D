...
/*   Updated: 2024/03/19 18:00:07 by ajeannin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	printf("angle du rayon : %f\n", angle);
	line = lines_intersections_test(game, game->player, angle, &dist_l);
//	printf("la?");
	col = col_intersections_test(game, game->player, angle, &dist_c);
