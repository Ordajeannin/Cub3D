...
/*   Updated: 2024/04/23 16:54:50 by pkorsako         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_telep(t_game *game, t_player *player)
{
	...
	if (telep && (player->is_in_telep == 0 || player->is_in_telep != c))
